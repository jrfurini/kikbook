...
<html>
	...
	<body style="background-color: #FFFFFF;">
		...
		<script src="/assets/js/jx_functions.js?v=1.28"></script>
		<script src="/assets/js/resize.js"></script>
	</body>
</html>

<?php log_message('error', 'GENERAL ERROR (início)' ); ?>
<?php log_message('error', '     Heading: ' . $heading );  ?>
<?php log_message('error', '         Msg: ' . $message );  ?>
<?php log_message('error', 'GENERAL ERROR (fim)' ); ?>
