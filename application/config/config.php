...
|
*/
$config['language']		= 'pt_BR'; /* Junior, 12/01/2012. */
/* quando não encontra o arquivo _lang para o idioma do usuário, usa o idioma abaixo para substituir. */
$config['default_language']	= 'pt_BR'; /* Junior, 27/02/2012. */
...
|
*/
$config['subclass_prefix'] = 'JX_'; //Junior, 12/01/2012
...
|
*/
$config['encryption_key'] = 'bkoiokk'; // Junior, 23/04/2012.
...
$config['sess_use_database']	= TRUE; // Junior, 26/01/2012
$config['sess_table_name']	= 'ci_sessions';
$config['sess_match_ip']	= FALSE;
$config['sess_match_useragent']	= TRUE;
$config['sess_time_to_update']	= 7200; // Junior, problemas com Ajax.
...
|
*/
$config['rewrite_short_tags'] = TRUE; // Junior, 30/03/2012
...
|
*/
$config['input_pagination_name'] = "jx_pagina_atual";

/*
|--------------------------------------------------------------------------
| Configuração do Single Pack - JX
|--------------------------------------------------------------------------
|
|
*/
...
$config['default_theme'] = 'kik';

$config['start_page'] = 'jx/start.html'; // Chamada quando o usuário não está logado ou o sistema não possui dados públicos.
...
$config['facebook_namespace'] = 'kikbok';
$config['facebook_app_page'] = 'kikbookoficial';
$config['facebook_update_token'] = 'k1g9i2o8k3o7b4g6o5loekajdusneinosre';

$config['google_analytics_id'] = "UA-37047889-1";


$config['robot_login'] = "k1g9i2o8k3o7b4g6o5loekajdusneinosre";
$config['robot_user'] = "jrfurini@gmail.com";
$config['robot_pass'] = "jrfurini";

/*
|--------------------------------------------------------------------------
| Configuração de Processos - JX
|--------------------------------------------------------------------------
|
|
*/
...
$config[ 'smtp_host' ]      = 'smtp.juniorfurini.com'; 		// SMTP Server Address.
$config[ 'smtp_user' ]      = 'noreply@juniorfurini.com'; 	// SMTP Username.
$config[ 'smtp_pass' ]      = 'k1i2k3b4o5o6k7'; 		// SMTP Password.
